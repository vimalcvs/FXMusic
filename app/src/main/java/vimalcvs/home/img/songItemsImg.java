package vimalcvs.home.img;
import android.graphics.LinearGradient;
import android.graphics.Path;import vimalcvs.api.shapeImg;

import android.graphics.Paint;
import android.graphics.Canvas;

public class songItemsImg
        extends shapeImg{
    ...
    class Path2 extends Path{
        public Path2() {
            moveTo(22.6f, 26.8f);
            quadTo(22f, 27.45f, 21.1f, 27.45f);
    ...
    class Path3 extends Path{
        public Path3() {
            ...
            quadTo(28.4f, 23.1f, 29f, 23.75f);
            quadTo(29.65f, 24.4f, 29.65f, 25.3f);
            quadTo(29.65f, 26.2f, 29f, 26.8f);
        }
    }
    ...
    class Path4 extends Path{
        public Path4() {
            moveTo(16.1f, 33.35f);
            quadTo(15.5f, 34f, 14.6f, 34f);
            quadTo(13.7f, 34f, 13.05f, 33.35f);
    ...
    class Path5 extends Path{
        public Path5() {
            ...
            quadTo(22f, 29.65f, 22.6f, 30.3f);
            quadTo(23.25f, 30.95f, 23.25f, 31.85f);
            quadTo(23.25f, 32.75f, 22.6f, 33.35f);
            quadTo(22f, 34f, 21.1f, 34f);
            quadTo(20.2f, 34f, 19.55f, 33.35f);
    ...
    class Path7 extends Path{
        public Path7() {
            moveTo(22.6f, 40.3f);
            quadTo(22f, 40.95f, 21.1f, 40.95f);
    ...
    public songItemsImg
        ...
        S5.transform(matrix);
        P5.setColor(0xFFd35d69);
        P5.setAntiAlias(true);

        S6.transform(matrix);
        P6.setColor(0xFFd35d69);
        P6.setAntiAlias(true);

        S7.transform(matrix);
        P7.setColor(0xFFd35d69);
