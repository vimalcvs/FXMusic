...
import com.vimal.api.EventCall;
import com.vimal.api.call;
import com.vimal.player.Ui;
import com.vimalcvs.music.player.playerEvents;
...
import vimalcvs.home.equalizer.eqlizerMain;
import vimalcvs.home.equalizer.eqlizerMenu;
import vimalcvs.home.views.playBtn;
import vimalcvs.home.views.playListBtn;
...
public class mainHome extends FMlyt{
	...
	public static String FACEBOOK_URL = "https://www.facebook.com/vimalcvs/";
	public static String FACEBOOK_PAGE_ID = "vimalcvs";
	...
	public mainHome(final Context context, final int width, final int height) {
			...
			public void onCall(boolean bl) {
				...
				/*Intent intent;
					try {
						...
						intent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://www.facebook.com/vimal.apps"));
					} catch (Exception e) {
						intent =  new Intent(Intent.ACTION_VIEW, Uri.parse("https://www.facebook.com/vimal.apps"));
					}
				...
				String facebookUrl = "https://www.facebook.com/vimalcvs/";
				try {
					...
					if (versionCode >= 3002850) {
						...
						Ui.ef.startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("fb://page/vimalcvs")));
					}
				} catch (PackageManager.NameNotFoundException e) {
		...
		FMText listText = textImg.getFMText(context,"VIMALCVS MUSIC PLAYER", Ui.cd.getHt(18));
		listText.height += Text.height + Ui.cd.getHt(10);
		listText.InCenter(SongItemsBtn);
		listText.setText("MUSIC PLAYER BY VIMALCVS");
		...
		PlayListText.setText("BY VIMALCVS.");
